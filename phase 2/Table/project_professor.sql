...
CREATE TABLE `professor` (
  ...
  CONSTRAINT `fk_professor_course1` FOREIGN KEY (`course_course_code`, `course_select_unit_course_sgroup`) REFERENCES `course` (`course_code`, `select_unit_course_sgroup`)
