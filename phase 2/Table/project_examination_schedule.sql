...
CREATE TABLE `examination_schedule` (
  ...
  `course_ename` varchar(45) DEFAULT NULL,
  `professor_ename` varchar(45) DEFAULT NULL,
  `exam_day` varchar(45) DEFAULT NULL,
  ...
  KEY `fk_examination_schedule_student1_idx` (`student_student_number`,`student_examination_schedule_course_eid`,`student_class_schedule_course_cid`),
  CONSTRAINT `fk_examination_schedule_student1` FOREIGN KEY (`student_student_number`, `student_examination_schedule_course_eid`, `student_class_schedule_course_cid`) REFERENCES `student` (`student_number`, `examination_schedule_course_eid`, `class_schedule_course_cid`)
