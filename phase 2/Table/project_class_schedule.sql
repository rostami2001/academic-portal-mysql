...
CREATE TABLE `class_schedule` (
  ...
  `course_cname` varchar(45) DEFAULT NULL,
  `number_of_course` int DEFAULT NULL,
  `professor_cname` varchar(45) DEFAULT NULL,
  `class_number` int DEFAULT NULL,
  `class_day` varchar(45) DEFAULT NULL,
  `class_time` int DEFAULT NULL,
  ...
  KEY `fk_class_schedule_student1_idx` (`student_student_number`,`student_examination_schedule_course_eid`,`student_class_schedule_course_cid`),
  CONSTRAINT `fk_class_schedule_student1` FOREIGN KEY (`student_student_number`, `student_examination_schedule_course_eid`, `student_class_schedule_course_cid`) REFERENCES `student` (`student_number`, `examination_schedule_course_eid`, `class_schedule_course_cid`)
