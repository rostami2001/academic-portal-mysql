...
CREATE TABLE `student` (
  ...
  KEY `s_u_c_s_idx` (`select_unit_course_sgroup`),
  KEY `fk_student_educational_records1_idx` (`educational_records_educational_records_id`),
  CONSTRAINT `fk_student_educational_records1` FOREIGN KEY (`educational_records_educational_records_id`) REFERENCES `educational_records` (`educational_records_id`)
